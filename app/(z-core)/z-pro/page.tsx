      ...
      <div className="max-w-6xl mx-auto space-y-10">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex gap-4">
            <Link 
              href="/z-pro/create-job"
              className="bg-muted border border-border px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-accent hover:text-black transition-all flex items-center gap-2"
            >
              <Plus size={18} /> Post Gig
            </Link>
            <Link 
              href="/z-pro/portfolio"
              className="bg-accent text-black px-8 py-3 rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all shadow-lg shadow-accent/20"
            >
              Build Resume
            </Link>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-muted border border-border p-8 rounded-[3rem]">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button className="px-4 py-2 bg-accent/5 border border-accent/20 border-dashed rounded-xl text-xs font-black text-accent hover:bg-accent/10 transition-all">
                  + Add New
                </button>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                {[1,2].map(i => (
                  <div key={i} className="bg-muted border border-border p-6 rounded-[2.5rem] flex items-center justify-between hover:border-accent/30 transition-all cursor-pointer group">
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        <h3 className="text-xl font-bold mb-1">UI/UX Design Intern</h3>
                        <div className="text-[10px] font-black text-accent uppercase tracking-widest">TechCorp • Remote</div>
                      </div>
                    </div>
            ...
            <div className="bg-muted border border-border p-8 rounded-[3rem]">
               ...
               <div className="space-y-4">
                  <div className="flex items-center justify-between">
                     <span className="text-xs font-bold text-foreground/60">Jobs Applied</span>
                     <span className="text-sm font-black">12</span>
                  </div>
                  <div className="flex items-center justify-between">
                     <span className="text-xs font-bold text-foreground/60">Profile Views</span>
                     <span className="text-sm font-black text-accent">842</span>
                  </div>
               </div>
            </div>
          </aside>
