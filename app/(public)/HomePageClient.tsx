...
import { ArrowRight, ChevronRight, Fingerprint, Activity, Lock, Radio, GraduationCap, Search, MessageSquare, MapPin, Heart } from 'lucide-react';
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-background border border-border rounded-xl p-8 flex flex-col group overflow-hidden relative min-h-[300px]">
            ...
            <div className="mt-8 rounded-lg border border-border bg-muted/20 p-4 transition-colors group-hover:bg-muted/40">
              <div className="rounded-md border border-border bg-background p-4 shadow-sm">
                <div className="mb-4 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border border-rose-500/30 bg-rose-500/10 text-rose-500">
                      <Heart size={16} />
                    </div>
                    <div>
                      <div className="h-2 w-28 rounded bg-foreground/30" />
                      <div className="mt-2 h-2 w-16 rounded bg-foreground/10" />
                    </div>
                  </div>
                  <span className="text-[10px] font-medium text-foreground/50">Just now</span>
                </div>
                <p className="text-sm font-medium leading-relaxed text-foreground/75">
                  To the person sketching beside the faculty cafe: your playlist made the whole queue better.
                </p>
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  <span className="inline-flex h-7 items-center gap-1.5 rounded-full border border-accent/20 bg-accent/10 px-3 text-[10px] font-bold uppercase tracking-wider text-accent">
                    <MapPin size={12} /> Faculty Cafe
                  </span>
                  <span className="inline-flex h-7 items-center gap-1.5 rounded-full border border-border bg-muted px-3 text-[10px] font-bold uppercase tracking-wider text-foreground/60">
      ...
      <section className="py-24 px-6 bg-muted/10 border-y border-border">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <h2 className="text-3xl md:text-5xl font-medium tracking-tight">
            From campus moments to<br />
            <span className="text-accent">lifelong opportunity.</span>
          </h2>
          ...
          <div className="grid gap-3 text-left sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={item} className="rounded-lg border border-border bg-background px-4 py-4 text-center text-xs font-black uppercase tracking-widest text-foreground/60">
                {item}
              </div>
            ))}
          </div>
